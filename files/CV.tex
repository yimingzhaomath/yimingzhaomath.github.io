...
\chead{{\large{\bf Yiming Zhao}}} \rhead{\today}\lfoot{} \rfoot{\bf \thepage} \cfoot{}
...
\begin{enumerate}
\item (with D. Xi) Geometric measures for radial Minkowski homomorphisms and Brunn-Minkowski-type inequalities, submitted to \emph{Journal f\"ur die reine und angewandte Mathematik}.
\item (with D. Xi) Fractional affine area measures, \emph{Journal of the European Mathematical Society}, accepted for publication.
...
\begin{itemize}
\item 2026 Jun. Brunn-Minkowski Theories conference at Shanghai, China: Minkowski problems inspired by Lutwak-Yang-Zhang.
\item 2026 Apr. The online Geometric and Functional Inequalities and Applications seminar: SL$(n)$-invariant isoperimetric and Minkowski problems
\item 2026 Mar. Binghamton University, Analysis Seminar: SL$(n)$-invariant isoperimetric and Minkowski problems.
...
\item 2020 Oct.  AMS special session (virtual): The Minkowski problem in Gaussian probability space.
...
\begin{itemize}
	...
	\item NSF CAREER panelist, 2025--2026
	\item NSF ad-hoc reviewer, 2025
	\item[-]\textbf{Committee services}
	\item Graduate Committee, Syracuse University, Fall 2025 -- Spring 2026
	...
	This workshop is designed to provide students enrolled in MAT-295 Calculus I at Syracuse University with \emph{just-in-time} algebra support. The idea is to have students brush up their relevant algebra skills to be used in the next Calculus Lecture. The workshop is co-organized by Pawel Grzegrzolka and myself, led by an undergraduate student, and funded by my NSF CAREER grant.
	...
	\item[-] \textbf{Journal referee}
		\item[]I refereed/provided quick opinion \emph{multiple times} for the following journals: 
		\begin{itemize}
			\item Advances in Applied Mathematics
			\item Advances in Geometry
			\item Advances in Mathematics
			\item Advanced Nonlinear Studies
			\item Bulletin des sciences math\'ematiques Calculus of Variations and Partial Differential Equations
...
\begin{itemize}
	\item Cory Monahan (Ph.D. student), since 2024
	\item Xinfa Meng (Ph.D. student), informally since 2024
\end{itemize}


{\large\textbf{Post-doc mentoring}}
\begin{itemize}
	\item Auttawich Manui (will arrive at Syracuse University in Fall 2026)
	\item Sudan Xing, 2023, currently Assistant Professor at University of Arkansas at Little Rock
\end{itemize}
